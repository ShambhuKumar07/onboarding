...
#         if form.is_valid():
#             # Save form data to the Profile model
...
#             return redirect('applicant:page_2')  # Redirect to page 2
#     else:
...
#     else:
#         form = FamilyDetailsForm(instance=profile)
...
from django.shortcuts import render, redirect
from .forms import FamilyDetailsForm
from users.models import Profile, FamilyMember
...
# def page_5(request):
#     if request.method == 'POST':
#         form = EducationalQualificationForm(request.POST, request.FILES)
#         if form.is_valid():
#             form.save()
...
#         if form.is_valid():
#             language_proficiency = form.save(commit=False)
#             language_proficiency.profile = profile  # Assign the profile
#             language_proficiency.save()
#             return redirect('applicant:page_7')  # Redirect to page 7
#     else:
#         form = LanguageProficiencyForm()
...
from django.shortcuts import redirect, render
from .forms import ReferencesForm
from users.models import Profile, Reference
